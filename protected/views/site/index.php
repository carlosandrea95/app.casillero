    ...
    <div class="container">
      <div class="row align-items-center py-md-5 py-3">
        ...
        <div class="col-md-7 content-photo mt-md-0 mt-5">
          <img src="<?php echo CUrl::baseUrl(); ?>assets/dist/images/main.jpg" class="img-fluid" alt="main image">
        </div>
      </div>
      <div class="clear"></div>
    </div>
  ...
  <div class="container py-md-3">
    ...
    <div class="row bottom_grids pt-md-3">
      <div class="col-lg-4 col-md-6 mt-5">
        <div class="s-block">
          <a href="#blog-single.html" class="d-block p-lg-4 p-3">
            <img src="<?php echo CUrl::baseUrl(); ?>assets/dist/images/s1.png" alt="" class="img-fluid" />
      ...
      <div class="col-lg-4 col-md-6 mt-5">
        <div class="s-block">
          <a href="#blog-single.html" class="d-block p-lg-4 p-3">
            <img src="<?php echo CUrl::baseUrl(); ?>assets/dist/images/s2.png" alt="" class="img-fluid" />
      ...
      <div class="col-lg-4 mt-5">
        <div class="s-block">
          <a href="#blog-single.html" class="d-block p-lg-4 p-3">
            <img src="<?php echo CUrl::baseUrl(); ?>assets/dist/images/s3.png" alt="" class="img-fluid" />
    ...
    <div class="container py-md-3">
      <div class="row cwp17-two align-items-center">
        <div class="col-md-6 cwp17-image">
          <img src="<?php echo CUrl::baseUrl(); ?>assets/dist/images/business.png" class="img-fluid" alt="" />
        </div>
...
<section class="w3l-index-block7 py-5">
  <div class="container py-md-3">
    <div class="row cwp17-two align-items-center">
      ...
      <div class="col-md-6 cwp17-image">
        <img src="<?php echo CUrl::baseUrl(); ?>assets/dist/images/mobile-app.png" class="img-fluid" alt="" />
      </div>
    </div>
  </div>
</section>
        ...
        <div class="col-md-10 mx-auto">
          <div class="owl-one owl-carousel owl-theme">
            <div class="item">
              <div class="slider-info mt-lg-4 mt-3">
                <div class="img-circle">
                  <img src="<?php echo CUrl::baseUrl(); ?>assets/dist/images/emp2.jpg" class="img-fluid rounded" alt="client image">
                </div>
            ...
            <div class="item">
              <div class="slider-info mt-lg-4 mt-3">
                <div class="img-circle">
                  <img src="<?php echo CUrl::baseUrl(); ?>assets/dist/images/emp1.jpg" class="img-fluid rounded" alt="client image">
                </div>
                <div class="message">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea sit id accusantium
                  officia quod quasi necessitatibus perspiciatis Harum error provident
                  quibusdam tenetur.</div>
            ...
            <div class="item">
              <div class="slider-info mt-lg-4 mt-3">
                <div class="img-circle">
                  <img src="<?php echo CUrl::baseUrl(); ?>assets/dist/images/emp3.jpg" class="img-fluid rounded" alt="client image">
                </div>
                <div class="message">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea sit id accusantium
                  officia quod quasi necessitatibus perspiciatis Harum error provident
                  quibusdam tenetur.</div>
            ...
            <div class="item">
              <div class="slider-info mt-lg-4 mt-3">
                <div class="img-circle">
                  <img src="<?php echo CUrl::baseUrl(); ?>assets/dist/images/emp4.jpg" class="img-fluid rounded" alt="client image">
                </div>
                <div class="message">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea sit id accusantium
                  officia quod quasi necessitatibus perspiciatis Harum error provident
                  quibusdam tenetur.</div>
